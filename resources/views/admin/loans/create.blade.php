        ...
        <form action="{{ route('admin.loans.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="loan_amount" id="loan_amount" value="{{ old('loan_amount') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('loan_amount') border-red-500 @enderror">
                    @error('loan_amount')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="number" step="0.01" name="interest_rate" id="interest_rate" value="{{ old('interest_rate') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('interest_rate') border-red-500 @enderror">
                    @error('interest_rate')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="number" name="loan_term" id="loan_term" value="{{ old('loan_term') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('loan_term') border-red-500 @enderror">
                    @error('loan_term')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <select name="term_unit" id="term_unit" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('term_unit') border-red-500 @enderror">
                        <option value="days" {{ old('term_unit') == 'days' ? 'selected' : '' }}>Days</option>
                        <option value="months" {{ old('term_unit') == 'months' ? 'selected' : '' }}>Months</option>
                    </select>
                    @error('term_unit')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="date" name="start_date" id="start_date" value="{{ old('start_date') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('start_date') border-red-500 @enderror">
                    @error('start_date')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="fine_rate" id="fine_rate" value="{{ old('fine_rate') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('fine_rate') border-red-500 @enderror">
                    @error('fine_rate')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <select name="fine_unit" id="fine_unit" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('fine_unit') border-red-500 @enderror">
                        <option value="percentage" {{ old('fine_unit') == 'percentage' ? 'selected' : '' }}>Percentage</option>
